...
# Config
Accounts = 100  # Number of accounts to create
MaxWindows = 5
ActualWindows = 0
...
def create_account(url, first_names, last_names):
    ...
    try:
        ...
        status("Please solve the CAPTCHA manually in the browser window...")
        while "https://www.roblox.com/" not in driver.current_url:
